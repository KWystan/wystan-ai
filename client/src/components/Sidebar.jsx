          ...
          <div className="flex-1 overflow-y-auto min-h-0">
            ...
            <div className="px-3 mt-3">
              <div className="flex items-center justify-between px-1 py-1">
                <button
                  ...
                  className="flex items-center gap-1 text-[11px] font-medium text-black/40 hover:text-black/70 transition-colors duration-150 uppercase tracking-wider"
                >
                ...
                <button
                  ...
                  className="w-5 h-5 rounded flex items-center justify-center text-black/30 hover:text-black hover:bg-black/5 transition-all duration-150"
            ...
            <div className="px-3 mt-3">
              <div className="flex items-center gap-1 px-1 py-1">
                <span className="material-symbols-outlined text-[14px] text-black/25">history</span>
              ...
              {loadingConversations && conversations.length === 0 ? (
                ...
                <div className="space-y-0.5 mt-0.5">
                  {unassignedConversations.map((conv) => (
                    <div
                      key={conv.id}
                      className={`relative group flex items-center px-2 py-1.5 rounded-lg cursor-pointer transition-colors duration-150 ${
                        conv.id === currentConversationId
                          ? 'bg-black/5 text-black'
                          : 'text-black/50 hover:bg-black/[0.03] hover:text-black/70'
                      }`}
